...
export const questionData: IQuestion[] = [
  ...
  },
  {
    ...
    answera: '다른 유튜버들을 가이드라인 삼아 비슷하게 만든다.',
  ...
  },
  {
    ...
    answerb: '칼로리를 계산하여 저울이나 스품으로 계량해서 급여한다.',
    type: 'SN',
  },
  {
    id: 7,
    ...
    answera:
      "'이건 이렇게 하면 어떨까?' 해결책을 함께 생각하며 정보를 같이 찾아본다.",
    answerb: "'아이고... 어쩌면 좋아.. ' 함께 슬퍼하며 위로를 해준다.",
    type: 'TF',
  },
  {
    id: 8,
    title: '고양이를 키우는데 가족과의 마찰이 생겼다. 나의 해결책은?',
    answera:
      '나의 생각과 논리가 맞다는 것을 증명하기 위해 가족들에게 설명한다.',
    answerb:
      '나의 의견이 상대방을 기본 나쁘게 하지 않도록 잘 전달하려고 먼저 생각한다.',
    type: 'TF',
  },
  {
    id: 9,
  ...
  },
  {
    ...
    answera: '고양이 상태에 맞춰 사료, 간식, 영양제를 줄 계획을 세운다.',
    answerb: '사료를 주면 알아서 먹겠지! 일단 자율 급식으로 한꺼번에 줘본다.',
    type: 'JP',
  },
  {
    id: 11,
    title: '고양이 사료가 우연히 여러 종류가 생겼다. 급여 방법은?',
    answera: '사료를 조급씩 급여해서 고양이 기호를 테스트해 보고 결정한다.',
    answerb: '그때 그때 주고 싶은 것을 급여한다.',
    type: 'JP',
  },
  {
    id: 12,
    title: '자기전 나는?',
    answera: '내일 고양이와 할 일을 미리 생각해 놓고 잔다.',
    answerb: '그냥 잔다.',
    type: 'JP',
  },
]
